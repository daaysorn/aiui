  ...
  return (
    <SidebarProvider className="h-svh overflow-hidden">
      <Sidebar variant="inset">
        ...
        <SidebarFooter>
          <div className="flex min-w-0 items-center gap-2 rounded-lg p-1.5 outline-solid outline-1 outline-transparent transition-[background-color] hover:bg-sidebar-accent hover:outline-border has-data-open:bg-sidebar-accent has-data-open:outline-border">
            <DropdownMenu>
