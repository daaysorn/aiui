    ...
    <li className="min-w-0">
      <article
        className={cn(
          ...
          recommended && !current && "bg-card ring-1 ring-inset ring-primary/35",
          current && "bg-muted/45",
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent
        ...
        className="max-h-[min(92dvh,44rem)] gap-0 overflow-hidden rounded-3xl bg-background p-0 shadow-lg ring-1 ring-inset ring-border sm:max-w-5xl"
      >
