  ...
  return (
    ...
    >
      <DialogContent
        ...
        className="flex h-[min(44rem,92svh)] w-full max-w-[calc(100%-1rem)] flex-col overflow-hidden rounded-3xl bg-background p-0 shadow-lg outline-solid outline-1 -outline-offset-1 outline-border sm:max-w-5xl sm:flex-row"
      >
