...
function SidebarInset({ className, ...props }: React.ComponentProps<"main">) {
  return (
    <main
      ...
      className={cn(
        "relative flex w-full flex-1 flex-col bg-background md:peer-data-[variant=inset]:m-2 md:peer-data-[variant=inset]:overflow-hidden md:peer-data-[variant=inset]:rounded-4xl md:peer-data-[variant=inset]:ring-1 md:peer-data-[variant=inset]:ring-inset md:peer-data-[variant=inset]:ring-muted-foreground/20",
        className
      )}
      {...props}
    />
