...
- The dashboard inset (the rounded main content panel) uses a muted edge only (`ring-muted-foreground/20` inset). Never use a strong border or full-opacity outline there.
